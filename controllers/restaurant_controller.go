...
func (s*RestaurantController) GetAllRestaurants(c *gin.Context) {
	...
	restaurants, err := s.RestaurantService.GetRestaurantByLocation(c, latitude, longitude)
	if err != nil {
...
func (s*RestaurantController) GetRestaurantByID(c *gin.Context) {
	...
	restaurant, err := s.RestaurantService.GetRestaurantByID(c, restaurantID, latitude, longitude)
	if err != nil {
